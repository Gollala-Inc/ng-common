...
import { BehaviorSubject, of, delay, tap, Subject, filter, map, mergeMap, Observable, catchError, throwError, timer, forkJoin } from 'rxjs';
...
class CartService {
        ...
        this.getAuthCart().pipe(catchError((e) => {
            ...
            * */
            let productCart = cartItems.reduce((result, cartItem) => {
                ...
                /* 카트 아이템에 대한 메모제이션 저장 */
                this._memoProductsInfo[cartItem._id] = Object.assign(Object.assign({}, cartItem), { product: productInfo });
    ...
    deleteProductOption(hasOneOption, cartItemId) {
        ...
        if (hasOneOption) {
            ...
            this.subtractCart([cartItem]).subscribe(() => {
                ...
                this.cartInfo$.next(Object.assign({}, this.cartInfo));
            }, (error) => {
                console.log(error);
    ...
    deleteExcelCart() {
        const memo = Object.assign({}, this._memoExcelsInfo);
    ...
    createCustomOrderUsingCartItems(items, phone) {
        ...
        return this.restService.POST('https://commerce-api.gollala.org/custom_order/', {
            body: Object.assign(Object.assign({}, body), { items })
        }).pipe(mergeMap((response) => {
            const items = idsInCartItems.map((id) => {
                return Object.assign(Object.assign({}, this._memoProductsInfo[id]), { product: this._memoProductsInfo[id].product.id });
            });
    ...
    updateAddress(id, body) {
        return this.restService.PUT('https://commerce-api.gollala.org/customer/auth/address', {
            body: Object.assign({ addressId: id }, body),
            handleError: true
        });
    }
    deleteAddress(id) {
    ...
    cartCheckout(body) {
        return this.restService.POST('https://commerce-api.gollala.org/cart/checkout', {
            body: Object.assign({ cartId: this._cartId }, body),
            handleError: true
        });
    }
...
CartService.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "13.1.3", ngImport: i0, type: CartService, deps: [{ token: i1$2.RestService }, { token: i1$2.DialogService }, { token: i1$2.LoadingService }], target: i0.ɵɵFactoryTarget.Injectable });
...
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "13.1.3", ngImport: i0, type: CartService, decorators: [{
        ...
        }], ctorParameters: function () { return [{ type: i1$2.RestService }, { type: i1$2.DialogService }, { type: i1$2.LoadingService }]; } });
...
OrderService.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "13.1.3", ngImport: i0, type: OrderService, deps: [{ token: RestService }], target: i0.ɵɵFactoryTarget.Injectable });
...
export { CartService, CommaSeparateNumberPipe, ConfirmDialogComponent, DialogService, IconComponent, LazyImageDirective, LoadingComponent, LoadingService, LocalStorageService, NgCommonModule, OrderService, RestService, RippleDirective, SecurityService };
