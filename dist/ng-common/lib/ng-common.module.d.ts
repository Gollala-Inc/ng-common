...
import * as i1 from "./pipe/comma-separate-number.pipe";
import * as i2 from "./component/confirm-dialog/confirm-dialog.component";
import * as i3 from "./component/image-magnifier-dialog/image-magnifier-dialog.component";
import * as i4 from "./component/loading/loading.component";
import * as i5 from "./directive/lazy-image.directive";
import * as i6 from "./component/icon/icon.component";
import * as i7 from "./directive/ripple.directive";
